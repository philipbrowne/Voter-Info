...
class StateModelTestCase(TestCase):
    ...
    def test_state_model(self):
        ...
        self.assertEqual(california.registration_url,
                         'https://registertovote.ca.gov/')
        self.assertEqual(california.name, 'California')
        self.assertEqual(california.capital, 'Sacramento')
        self.assertEqual(repr(california),
                         f'<State {california.id} {california.name}>')
    ...
    def test_user_state(self):
        ...
        self.assertEqual(u1.state.elections_url,
                         'https://www.sos.ca.gov/elections')
        self.assertEqual(u1.state.registration_online_deadline,
