...
class UserModelTestCase(TestCase):
    ...
    def test_user_model(self):
        ...
        db.session.commit()
        u1 = User(username='TEST_USER', password='TEST_HASHED_PW', first_name='TEST_FIRST', last_name='TEST_LAST',
                  street_address='TEST_STREET_ADDRESS', city='TEST_CITY', state_id='CA', zip_code='21046', email='TESTEMAIL@test.com')
        db.session.add(u1)
        db.session.commit()
    ...
    def test_user_register(self):
        ...
        db.session.commit()
        u1 = User(username='TEST_USER', password='TEST_HASHED_PW', first_name='TEST_FIRST', last_name='TEST_LAST',
                  street_address='TEST_STREET_ADDRESS', city='TEST_CITY', county='TEST_COUNTY', state_id='CA', zip_code='21046', email='TESTEMAIL@test.com')
        u3 = u1.register(u1.username, u1.password, u1.first_name, u1.last_name,
                         u1.street_address, u1.city, u1.county, u1.state_id, u1.zip_code, u1.email)
        db.session.commit()
    ...
    def test_duplicate_user(self):
        ...
        u1 = User(username='TEST_USER', password='TEST_HASHED_PW', first_name='TEST_FIRST', last_name='TEST_LAST',
                  street_address='TEST_STREET_ADDRESS', city='TEST_CITY', state_id='CA', zip_code='21046', email='TESTEMAIL@test.com')
        u1 = u1.register(u1.username, u1.password, u1.first_name, u1.last_name,
                         u1.street_address, u1.city, u1.county, u1.state_id, u1.zip_code, u1.email)
        db.session.add(u1)
        db.session.commit()
        dupe1 = User(username='TEST_USER', password='DUPE_HASHED_PW', first_name='DUPE_FIRST', last_name='DUPE_LAST',
                     street_address='DUPE_STREET_ADDRESS', city='DUPE_CITY', state_id='CA', zip_code='21046', email='DUPEEMAIL@test.com')
        db.session.add(dupe1)
        self.assertRaises(IntegrityError, db.session.commit)
        db.session.rollback()
        dupe2 = User(username='UNIQUE_USER', password='UNIQUE_HASHED_PW', first_name='UNIQUE_FIRST', last_name='UNIQUE_LAST',
                     street_address='UNIQUE_STREET_ADDRESS', city='UNIQUE_CITY', state_id='CA', zip_code='21046', email='TESTEMAIL@test.com')
    ...
    def test_user_login(self):
        ...
        db.session.commit()
        u2 = u1.register(u1.username, u1.password, u1.first_name, u1.last_name,
                         u1.street_address, u1.city, u1.county, u1.state_id, u1.zip_code, u1.email)
        db.session.commit()
